    ...
    render() {
        return (
            <ScrollView style={{ flex: 1 }}>
                <LinearGradient colors={['#396afc', '#2948ff']} start={[0.0, 0.5]} end={[1.0, 0.8]} style={styles.gradient_logo}>
                ...
                <View style={styles.menu_container}>
                    ...
                    <SlideInLeft index={3}>
                        <TouchableOpacity>
                            <LinearGradient colors={['#396afc', '#2948ff']} start={[0.0, 0.5]} end={[1.0, 0.8]} style={styles.menu_item_openrad}>
                                <View style={styles.first_item_container}>
